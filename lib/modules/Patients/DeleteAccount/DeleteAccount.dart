...
import 'package:eshop/modules/Patients/DeleteAccount/DeleteAccountController.dart';
...
class _DeleteAccountPanelState extends State<DeleteAccountPanel> {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => deleteAccountController.confirmDelete.value
          ? Column(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    Get.back();
                    deleteAccountController.confirmDelete.value = false;
                  },
                  child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  controller:
                                      deleteAccountController.otpController,
